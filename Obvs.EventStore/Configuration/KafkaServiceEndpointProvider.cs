...
namespace Obvs.Kafka.Configuration
{
        ...
        where TResponse : class, TMessage
    {
        ...
        private readonly EventStoreProducerConfig _producerConfiguration;
            ...
            : base(serviceName)
        {
            ...
            _producerConfiguration = producerConfiguration ?? new EventStoreProducerConfig();
        ...
        private IMessagePublisher<T> CreatePublisher<T>(KafkaConfiguration kafkaConfiguration, EventStoreProducerConfig producerConfiguration, string topic) where T : class, TMessage
        {
